...
# 环境变量
UUID = os.environ.get('UUID', 'a2d03f6b-c556-4811-8d9a-0147e6e6178e')   # 节点UUID
...
SUB_PATH = os.environ.get('SUB_PATH', 'lol')         # 节点订阅token
NAME = os.environ.get('NAME', '')                    # 节点名称
WSPATH = os.environ.get('WSPATH', UUID[:8])          # 节点路径
PORT = int(os.environ.get('SERVER_PORT') or os.environ.get('PORT') or 3415)  # http和ws端口，默认自动优先获取容器分配的端口
